...
<section id="mobile-products" className="product-store position-relative padding-large no-padding-top">
  <div className="container">
    <div className="row">
      ...
      {/* Product Cards */}
      {[
        { id: 1, imgSrc: "images/product-item1.jpg", title: "Iphone 10", price: "" },
        { id: 2, imgSrc: "images/product-item2.jpg", title: "Iphone 11", price: "" },
        { id: 3, imgSrc: "images/product-item3.jpg", title: "Iphone 8", price: "" },
      ].map((product) => (
